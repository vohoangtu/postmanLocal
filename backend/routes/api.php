...
// WorkspaceController removed - không còn workspace concept
...
Route::middleware('api')->group(function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::get('/collections/templates', [CollectionController::class, 'getTemplates']);
        
        // Collection Permissions
        Route::get('/collections/{collectionId}/permissions', [\App\Http\Controllers\CollectionPermissionController::class, 'index']);
        Route::put('/collections/{collectionId}/permissions', [\App\Http\Controllers\CollectionPermissionController::class, 'update']);
        Route::put('/collections/{collectionId}/permissions/{userId}', [\App\Http\Controllers\CollectionPermissionController::class, 'setUserPermission']);
        Route::delete('/collections/{collectionId}/permissions/{userId}', [\App\Http\Controllers\CollectionPermissionController::class, 'removeUserPermission']);
        
        // Environments
        Route::apiResource('environments', EnvironmentController::class);
        Route::post('/environments/sync', [EnvironmentController::class, 'sync']);
        
        // Environments (user-based, không còn workspace)
        ...
        // Workspaces - DEPRECATED, sẽ được remove sau khi migrate frontend
        ...
        // Workspace documentation - DEPRECATED
        
        // API Schemas (user-based, không còn workspace)
        ...
        // Mock Servers (user-based, không còn workspace)
        Route::get('/mock-servers', [\App\Http\Controllers\MockServerController::class, 'index']);
        Route::post('/mock-servers', [\App\Http\Controllers\MockServerController::class, 'store']);
        ...
        // API Test Suites (collection-based)
        Route::get('/collections/{collectionId}/test-suites', [\App\Http\Controllers\ApiTestController::class, 'index']);
        Route::post('/collections/{collectionId}/test-suites', [\App\Http\Controllers\ApiTestController::class, 'store']);
        ...
        Route::post('/schemas/from-template', [\App\Http\Controllers\ApiTemplateController::class, 'createFromTemplate']);
        
        // API Design Reviews
        Route::post('/schemas/{id}/request-review', [\App\Http\Controllers\ApiDesignReviewController::class, 'requestReview']);
        // Design Reviews (collection-based)
        Route::get('/collections/{collectionId}/design-reviews', [\App\Http\Controllers\ApiDesignReviewController::class, 'index']);
        ...
        // Tasks (collection-based)
        Route::get('/collections/{collectionId}/tasks', [\App\Http\Controllers\TaskController::class, 'index']);
        Route::post('/collections/{collectionId}/tasks', [\App\Http\Controllers\TaskController::class, 'store']);
        ...
        // Discussions (collection-based)
        Route::get('/collections/{collectionId}/discussions', [\App\Http\Controllers\DiscussionController::class, 'index']);
        Route::post('/collections/{collectionId}/discussions', [\App\Http\Controllers\DiscussionController::class, 'store']);
        ...
        // Reviews đã có route collection-based ở trên
        ...
        // Activity Logs (collection-based và user-based)
