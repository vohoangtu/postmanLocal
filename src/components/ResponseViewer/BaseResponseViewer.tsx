/**
 * Base Response Viewer Component
 * Component cơ bản chứa tất cả logic chung cho việc hiển thị response
 * Được sử dụng bởi cả PublicResponseViewer và WorkspaceResponseViewer
 */
...
export interface BaseResponseViewerProps {
  response: any;
  responseTime?: number;
...
export default function BaseResponseViewer({
  response,
  responseTime,
  enableCollaboration = false,
  renderCollaborationPanel,
  requestId
}: BaseResponseViewerProps) {
